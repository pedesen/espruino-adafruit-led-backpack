...
/**
 * Scrolls a text from right to left
 *
 * @param  {string} text
 * @param  {number} speed
 */
Matrix.prototype.startScrollText = function(text, speed) {
    this.stopScrollText();
    var n = -this.context.getWidth();
    var self = this;
...
Matrix.prototype.stopScrollText = function() {
